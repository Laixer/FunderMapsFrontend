import EnvironmentDamageCharacteristics from '@/models/EnvironmentDamageCharacteristics'
import FoundationDamageCause from '@/models/FoundationDamageCause'
import FoundationDamageCharacteristics from '@/models/FoundationDamageCharacteristics'
import FoundationType from '@/models/FoundationType'
import Vue from 'vue'
